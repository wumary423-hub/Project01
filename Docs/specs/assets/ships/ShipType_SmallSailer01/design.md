...
1. 主桅结构与视觉均在船体纵向中心线；
2. **船长固定为 15m；主桅长度固定为 18m（桅脚至桅顶）**。两者均为明确尺寸，不得继续写成“约 15m”或仅用 `mast_length > ship_length` 代替；
3. 取消船尾布料顶棚；
4. 低矮明确的木质两层艉楼；
...
以 Cog (ship) 为历史原型；一眼仍是 V0.8 同一艘船；首尾未修平；**船长 15m；主桅居中且长度 18m**；低矮两层艉楼；主甲板至艉楼平台只有一套贴一侧船舷的木质楼梯且不得居中；货舱口只有一个且不与主桅/桅座位置重叠；全船四个炮窗、每舷两个、沿纵向中心线镜像对应且位于顶层甲板对应舷侧区域；中线舵；无展开大帆；无木桶杂物；无 AI 歧义结构。
