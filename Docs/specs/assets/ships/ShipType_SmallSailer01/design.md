...
5. 主甲板到艉楼屋顶平台只设置**一套木质楼梯**；楼梯必须位于**船体内部**并靠一侧船舷布置，不得居中；楼梯下端落在主甲板，上端到达艉楼屋顶平台；具体采用左舷还是右舷尚未锁定；不得做成左右对称双楼梯；
...
以 Cog (ship) 为历史原型；保持短宽厚实船体与首尾个性过渡；**船长 15m；主桅居中且长度 18m**；艉楼为单层、地板与主甲板同层、屋顶为可上人平台；楼梯只有一套、位于船体内部并贴一侧船舷、下端在主甲板、上端到艉楼屋顶；货舱口只有一个、尺寸紧凑且不与主桅/桅座重叠；全船四个炮窗、每舷两个、沿纵向中心线镜像、位于顶层甲板对应舷侧区域且尺寸一致；中线舵；无木桶杂物；无 AI 歧义结构。
